...
与长尾块限制，目标 **全量 < 20 分钟**（gov5 49m48s；已于 08-31 达成：19.7 min），密集 band > 6,000 blk/s
...
**全链 25,864,982 块、37.07 亿笔交易、315,472 Ggas，回放并逐块验证
19.7 分钟：266.4 Ggas/s、313 万 TPS、每物理核 2.08 Ggas/s——gov5 的
2.08×，目标"全量 < 20 分钟"达成。**（PGO+gmp 构建、安静机器；
明细见下表与 `../pevm/docs/witness.md`。）
...
| 08-31：PGO+gmp 构建、安静机器 | **19.7 min** | 297,481 | **全部块，0 失败、0 任务中止**；266.4 Ggas/s、313 万 TPS；同构建在有轻负载共盘时 20.0 min |
